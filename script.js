...
function displayCountries(file){
   let htmlData=``
   for(let p of file){
    ...
    let languagesArray=[]
    if(p.languages.length>0){ //incase no languages don't work
      p.languages.forEach(c=>languagesArray.push(c.name))
     
    }
    htmlData+=`
    <div class="col-3 mt-1">
                <div class="card text-bg-light">
                    <img src="${flag}" class="card-img" alt="..." height="200px;">
                    <div class="card-img-overlay text-black">
                      <h5 class="card-title">${name}</h5>
                      <p class="card-text">${capital}</p>
                      <p class="card-text"><small>Language: ${languagesArray}</small></p>
